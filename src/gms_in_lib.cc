...
int main(int argc, char* argv[])
{
	...
	String imgL_path = cmd.get<String>("left");
	String imgR_path = cmd.get<String>("right");

	bool withRotation = cmd.get<bool>("withRotation");
	bool withScale = cmd.get<bool>("withScale");
	bool drawSimple = cmd.get<bool>("drawSimple");
